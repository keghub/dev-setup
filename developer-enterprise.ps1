...
#--- Visual Studio ---
cinst visualstudio2015enterprise -y --cacheInstaller "$env:UserProfile\AppData\Local\ChocoCache"

cinst visualstudio2017enterprise -y --cacheInstaller "$env:UserProfile\AppData\Local\ChocoCache"
